...
import { idlFactory } from './relayer.did.js';
export { idlFactory } from './relayer.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RELAYER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./relayer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the relayer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./relayer.did.js")._SERVICE>}
 */
export const relayer = createActor(canisterId);
