...
import { idlFactory } from './jpyc_wrapper.did.js';
export { idlFactory } from './jpyc_wrapper.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_JPYC_WRAPPER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./jpyc_wrapper.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the jpyc_wrapper canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./jpyc_wrapper.did.js")._SERVICE>}
 */
export const jpyc_wrapper = createActor(canisterId);
